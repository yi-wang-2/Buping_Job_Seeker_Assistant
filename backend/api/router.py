...
from backend.api.endpoints import ai_metrics, ai_skills, resume, interview, settings, history, job_radar, job_tracker, memory
...
api_router.include_router(job_radar.router, prefix="/job-radar", tags=["job-radar"])
